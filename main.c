...
/*   Updated: 2018/08/23 17:34:41 by bopopovi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main()
{
	...
	t_dbl test;
	test.bits.mant = 82345;
	test.bits.expn = 2047;
	test.val = 111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111.42;
	frval = ft_printf("%25.17F F\n", test.val); // INFINITY TEST CASE
	prval = printf("%25.17F P\n", test.val); // INFINITY TEST CASE
	printf("prval = %d, frval = %d\n", prval, frval);
